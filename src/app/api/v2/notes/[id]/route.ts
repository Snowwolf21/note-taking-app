...
export async function GET(
  ...
  try {
    ...
    console.error('Error fetching note V2:', error);
...
export async function PUT(
  ...
  try {
    ...
    console.error('Error updating note V2:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    console.error('Error toggling archive V2:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error deleting note V2:', error);
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
  }
}
