      ...
      <div className="w-full max-w-md bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-xl shadow-2xl overflow-hidden p-6 space-y-5 animate-in fade-in zoom-in-95">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-3 text-red-500">
            ...
            <h3 id="confirm-modal-title" className="text-lg font-bold text-[var(--text-main)]">
              {title}
            </h3>
          </div>
          <button
        ...
        <div className="flex items-center justify-end space-x-3 pt-2">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium rounded-lg text-[var(--text-main)] bg-[var(--bg-surface-hover)] hover:opacity-90 focus-ring"
          >
            {cancelLabel}
          </button>
          <button
